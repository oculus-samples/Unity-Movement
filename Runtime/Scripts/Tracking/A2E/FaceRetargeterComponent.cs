...
namespace Meta.XR.Movement.FaceTracking.Samples
{
    ...
    public class FaceRetargeterComponent : WeightsProvider
    {
        ...
        // <inheritdoc />
        public override IReadOnlyList<string> GetWeightNames()
        {
            EnsureInitialized();
        ...
        // <inheritdoc />
        public override IReadOnlyList<float> GetWeights()
        {
            EnsureInitialized();
        ...
        private void EnsureInitialized()
        {
            ...
            _input = Enumerable.Repeat(0.0f, _retargeter.InputSignals.Count).ToArray();
            _output = Enumerable.Repeat(0.0f, _retargeter.OutputSignals.Count).ToArray();
        }
    }
}

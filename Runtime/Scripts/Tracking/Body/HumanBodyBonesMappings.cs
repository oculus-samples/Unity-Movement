...
{
    public class HumanBodyBonesMappings
    {
        /// <summary>
        ...
        /// </summary>
        public static Dictionary<HumanBodyBones, Tuple<HumanBodyBones, HumanBodyBones>>
            BoneToJointPair = new Dictionary<HumanBodyBones, Tuple<HumanBodyBones, HumanBodyBones>>()
            {
                ...
                { HumanBodyBones.LeftThumbDistal,
                    new Tuple<HumanBodyBones, HumanBodyBones>(HumanBodyBones.LeftThumbDistal, HumanBodyBones.LastBone ) }, // Invalid.
                ...
                { HumanBodyBones.LeftIndexDistal,
                    new Tuple<HumanBodyBones, HumanBodyBones>(HumanBodyBones.LeftIndexDistal, HumanBodyBones.LastBone ) }, // Invalid.
                ...
                { HumanBodyBones.LeftMiddleDistal,
                    new Tuple<HumanBodyBones, HumanBodyBones>(HumanBodyBones.LeftMiddleDistal, HumanBodyBones.LastBone ) }, // Invalid.
                ...
                { HumanBodyBones.LeftRingDistal,
                    new Tuple<HumanBodyBones, HumanBodyBones>(HumanBodyBones.LeftRingDistal, HumanBodyBones.LastBone ) }, // Invalid.
                ...
                { HumanBodyBones.LeftLittleDistal,
                    new Tuple<HumanBodyBones, HumanBodyBones>(HumanBodyBones.LeftLittleDistal, HumanBodyBones.LastBone ) }, // Invalid.
                ...
                { HumanBodyBones.RightThumbDistal,
                    new Tuple<HumanBodyBones, HumanBodyBones>(HumanBodyBones.RightThumbDistal, HumanBodyBones.LastBone ) }, // Invalid.
                ...
                { HumanBodyBones.RightIndexDistal,
                    new Tuple<HumanBodyBones, HumanBodyBones>(HumanBodyBones.RightIndexDistal, HumanBodyBones.LastBone ) }, // Invalid.
                ...
                { HumanBodyBones.RightMiddleDistal,
                    new Tuple<HumanBodyBones, HumanBodyBones>(HumanBodyBones.RightMiddleDistal, HumanBodyBones.LastBone ) }, // Invalid.
                ...
                { HumanBodyBones.RightRingDistal,
                    new Tuple<HumanBodyBones, HumanBodyBones>(HumanBodyBones.RightRingDistal, HumanBodyBones.LastBone ) }, // Invalid.
                ...
                { HumanBodyBones.RightLittleDistal,
                    new Tuple<HumanBodyBones, HumanBodyBones>(HumanBodyBones.RightLittleDistal, HumanBodyBones.LastBone ) }, // Invalid.
            };

        /// <summary>
        /// Paired human body bones with body sections.
        /// </summary>
        public static Dictionary<HumanBodyBones, BodySection> BoneToBodySection =
        ...
        /// </summary>
        public static Dictionary<OVRSkeleton.BoneId, HumanBodyBones> BoneIdToHumanBodyBone =
        ...
        /// create the "axis" of the bone.
        /// </summary>
        public static Dictionary<OVRSkeleton.BoneId, Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>>
            BoneIdToJointPair = new Dictionary<OVRSkeleton.BoneId, Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>>()
            {
                { OVRSkeleton.BoneId.Body_Neck,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_Neck, OVRSkeleton.BoneId.Body_Head )
                },
                { OVRSkeleton.BoneId.Body_Head,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_Head, OVRSkeleton.BoneId.Invalid )
                },

                { OVRSkeleton.BoneId.Body_Root,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_Root, OVRSkeleton.BoneId.Body_Hips )
                },
                { OVRSkeleton.BoneId.Body_Hips,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_Hips, OVRSkeleton.BoneId.Body_SpineLower )
                },
                { OVRSkeleton.BoneId.Body_SpineLower,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_SpineLower, OVRSkeleton.BoneId.Body_SpineMiddle )
                },
                { OVRSkeleton.BoneId.Body_SpineMiddle,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_SpineMiddle, OVRSkeleton.BoneId.Body_SpineUpper )
                },
                { OVRSkeleton.BoneId.Body_SpineUpper,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_SpineUpper, OVRSkeleton.BoneId.Body_Chest )
                },
                { OVRSkeleton.BoneId.Body_Chest,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_Chest, OVRSkeleton.BoneId.Body_Neck )
                },

                { OVRSkeleton.BoneId.Body_LeftShoulder,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftShoulder, OVRSkeleton.BoneId.Body_LeftArmUpper )
                },
                { OVRSkeleton.BoneId.Body_LeftScapula,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftScapula, OVRSkeleton.BoneId.Body_LeftArmUpper )
                },
                { OVRSkeleton.BoneId.Body_LeftArmUpper,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftArmUpper, OVRSkeleton.BoneId.Body_LeftArmLower )
                },
                { OVRSkeleton.BoneId.Body_LeftArmLower,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftArmLower, OVRSkeleton.BoneId.Body_LeftHandWrist )
                },
                { OVRSkeleton.BoneId.Body_LeftHandWrist,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftHandWrist, OVRSkeleton.BoneId.Body_LeftHandMiddleMetacarpal )
                },
                { OVRSkeleton.BoneId.Body_LeftHandPalm,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftHandPalm, OVRSkeleton.BoneId.Body_LeftHandMiddleMetacarpal )
                },
                { OVRSkeleton.BoneId.Body_LeftHandWristTwist,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftHandWristTwist, OVRSkeleton.BoneId.Body_LeftHandMiddleMetacarpal )
                },

                { OVRSkeleton.BoneId.Body_LeftHandThumbMetacarpal,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftHandThumbMetacarpal, OVRSkeleton.BoneId.Body_LeftHandThumbProximal )
                },
                { OVRSkeleton.BoneId.Body_LeftHandThumbProximal,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftHandThumbProximal, OVRSkeleton.BoneId.Body_LeftHandThumbDistal )
                },
                { OVRSkeleton.BoneId.Body_LeftHandThumbDistal,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftHandThumbDistal, OVRSkeleton.BoneId.Body_LeftHandThumbTip )
                },
                { OVRSkeleton.BoneId.Body_LeftHandThumbTip,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftHandThumbDistal, OVRSkeleton.BoneId.Body_LeftHandThumbTip )
                },
                { OVRSkeleton.BoneId.Body_LeftHandIndexMetacarpal,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftHandIndexMetacarpal, OVRSkeleton.BoneId.Body_LeftHandIndexProximal )
                },
                { OVRSkeleton.BoneId.Body_LeftHandIndexProximal,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftHandIndexProximal, OVRSkeleton.BoneId.Body_LeftHandIndexIntermediate )
                },
                { OVRSkeleton.BoneId.Body_LeftHandIndexIntermediate,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftHandIndexIntermediate, OVRSkeleton.BoneId.Body_LeftHandIndexDistal )
                },
                ...
                { OVRSkeleton.BoneId.Body_LeftHandLittleTip,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_LeftHandLittleDistal, OVRSkeleton.BoneId.Body_LeftHandRingTip )
                },

                { OVRSkeleton.BoneId.Body_RightShoulder,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_RightShoulder, OVRSkeleton.BoneId.Body_RightArmUpper )
                },
                { OVRSkeleton.BoneId.Body_RightScapula,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_RightScapula, OVRSkeleton.BoneId.Body_RightArmUpper )
                },
                { OVRSkeleton.BoneId.Body_RightArmUpper,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_RightArmUpper, OVRSkeleton.BoneId.Body_RightArmLower )
                },
                { OVRSkeleton.BoneId.Body_RightArmLower,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_RightArmLower, OVRSkeleton.BoneId.Body_RightHandWrist )
                },
                ...
                { OVRSkeleton.BoneId.Body_RightHandWristTwist,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_RightHandWristTwist, OVRSkeleton.BoneId.Body_RightHandMiddleMetacarpal )
                },
                ...
                { OVRSkeleton.BoneId.Body_RightHandLittleTip,
                    new Tuple<OVRSkeleton.BoneId, OVRSkeleton.BoneId>(OVRSkeleton.BoneId.Body_RightHandLittleDistal, OVRSkeleton.BoneId.Body_RightHandRingTip )
                },
            };
    }
}

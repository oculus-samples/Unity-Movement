...
namespace Oculus.Movement.Utils
{
    ...
    public class AddComponentsHelper
    {
        ...
        [Obsolete("SetUpCharacterForCorrectivesFace is deprecated; please use SetUpCharacterForA2EFace instead.")]
        /// <summary>
        ...
        [Obsolete("SetUpCharacterForARKitFace is deprecated; please use SetUpCharacterForA2EARKitFace instead.")]
        /// <summary>
        ...
        {
            OVRWeightsProvider ovrWeightsProvider = GameObject.FindObjectOfType<OVRWeightsProvider>();
            ...
            {
                OVRFaceExpressions ovrFaceExpressions = GameObject.FindObjectOfType<OVRFaceExpressions>();
            ...
            string presetName)
        {
            ...
            if (retargeterComponent.RetargeterConfig == null)
            {
                ...
                var packagesPath = Path.Combine(new string[] {
                    "Packages", "com.meta.movement", "Shared", "TrackingPresets"});
            ...
            RigType rigType)
        {
            ...
            if (faceDriver.Meshes == null || faceDriver.Meshes.Count == 0)
            {
                ...
                faceDriver.Meshes = blendshapeMeshRenders;
#if UNITY_EDITOR
                if (!runtimeInvocation)
                {

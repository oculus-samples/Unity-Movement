...
using Meta.XR.Movement.Fitness;
...
namespace Meta.XR.Movement.BodyTrackingForFitness
{
    ...
    public class BodyPoseAlignmentDetector : MonoBehaviour
    {
        ...
        /// <summary>
        /// Skeletal draw containers.
        /// </summary>
        [SerializeField]
        protected List<SkeletalDrawContainer> _skeletalDrawContainers;
        ...
        private void CompareLogic()
        {
            ...
            _alignmentStates.ForEach(
                state => _skeletalDrawContainers.ForEach(visuals => ColorBoneByState(visuals, state)));
        }
        ...
        private void ColorBoneByState(SkeletalDrawContainer boneVisuals, AlignmentState state)
        {
            int bodyJointId = (int)state.Id;
            if (boneVisuals == null || boneVisuals.NumBonesToDraw == 0 ||
                bodyJointId < 0 || bodyJointId >= boneVisuals.NumBonesToDraw)
            {
                return;
            }
            ...
            boneVisuals.ColorSkeletalBoneByIndex(bodyJointId, color);
        }

...
{
    /// <summary>
    /// The network pose retargeter behaviour interface.
    /// </summary>
    public interface INetworkPoseRetargeterBehaviour
    {
        /// <summary>
        ...
        /// <summary>
        /// The current render time. This is used for snapshot interpolation to get the

...
using UnityEditor;
using UnityEngine;
using static Meta.XR.Movement.Networking.NGO.Editor.NetworkCharacterSpawnerNGOEditor;

namespace Meta.XR.Movement.Networking.NGO.Editor
{
    [InitializeOnLoad]
    internal static class NetworkCharacterNGOSetupRules
    {
        static NetworkCharacterNGOSetupRules()
        {
            ...
            var spawnerPrefab = MSDKUtilityEditor.FindPrefab(SpawnerPrefabName);
            var characterPrefab = MSDKUtilityEditor.FindPrefab(CharacterPrefabName);
